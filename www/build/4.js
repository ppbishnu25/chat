...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__passwordreset__ = __webpack_require__(707);
...
var PasswordresetPage = /** @class */ (function () {
    ...
    PasswordresetPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-passwordreset',template:/*ion-inline-start:"/Users/bishnureddy/Desktop/MyIonicproject/chat/src/pages/passwordreset/passwordreset.html"*/'<ion-content class="background">\n  <ion-card>\n    <ion-card-header>\n      Password Reset\n    </ion-card-header>\n    <ion-card-content>\n      <ion-list >\n        <ion-item>\n            <ion-input type="email" [(ngModel)]="email" placeholder="Email"></ion-input>\n        </ion-item>\n        <button ion-button block round outline color="light" (click)="reset()">Reset my Password</button>\n        <button ion-button full clear color="light" (click)="goback()">Go Back</button>\n      </ion-list>\n    </ion-card-content>\n  </ion-card>\n  </ion-content>'/*ion-inline-end:"/Users/bishnureddy/Desktop/MyIonicproject/chat/src/pages/passwordreset/passwordreset.html"*/,
        }),
